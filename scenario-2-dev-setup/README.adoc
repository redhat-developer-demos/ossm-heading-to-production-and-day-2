...
The link:https://github.com/redhat-developer-demos/ossm-heading-to-production-and-day-2/blob/main/scenario-1-kick-off-meeting/README.adoc#mapping-enterprise-users-to-roles-in-the-dev-environment[`DEV` Environment users] have been defined during `Kick Off Meeting`
...
3. As *phillip* (`Cluster Admin`) create the link:https://github.com/redhat-developer-demos/ossm-heading-to-production-and-day-2/blob/main/scenario-1-kick-off-meeting/README.adoc#roleusercreation[`Service Mesh Roles`]
...
+
image::./images/kiali-cristina-domain-owner-tp.png[400,1000]
...
+
image::./images/kiali-farid-domain-owner-ts.png[400,1000]
