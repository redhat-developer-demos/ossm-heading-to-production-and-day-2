...
The requirements below are a summary and refinement, based on further analysis, of functional and non-functional _needs_ in production (originally defined during the xref:../scenario-1-kick-off-meeting/README.adoc#requirements-capture-to-drive-mesh-adoption--configuration[Kickoff Meeting Requirements gathering]):
